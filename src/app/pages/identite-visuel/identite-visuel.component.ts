...
@Component({
  selector: 'app-identite-visuel',
  templateUrl: './identite-visuel.component.html',
  styleUrls: ['./identite-visuel.component.less']
})
export class IdentiteVisuelComponent implements OnInit {
