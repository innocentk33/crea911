...
@Component({
  ...
  templateUrl: './design-despace.component.html',
  styleUrls: ['./design-despace.component.less']
})
export class DesignDespaceComponent implements OnInit {
