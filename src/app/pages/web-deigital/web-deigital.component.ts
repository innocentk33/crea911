...
@Component({
  selector: 'app-web-deigital',
  templateUrl: './web-deigital.component.html',
  styleUrls: ['./web-deigital.component.less']
})
export class WebDeigitalComponent implements OnInit {
